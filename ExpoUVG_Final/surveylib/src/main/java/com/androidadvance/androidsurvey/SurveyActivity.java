...
public class SurveyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (Question mQuestion : mSurveyPojo.getQuestions()) {
            ...
            if (mQuestion.getQuestionType()==0) {
            ...
            if (mQuestion.getQuestionType()==2) {
            ...
            if (mQuestion.getQuestionType()==1) {
            ...
            if (mQuestion.getQuestionType()==3) {
            ...
            if (mQuestion.getQuestionType()==4) {

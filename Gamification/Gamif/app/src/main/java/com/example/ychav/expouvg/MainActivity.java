...
//primera fila de estrellas
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (itemID) {
            ...
            case R.id.btnRetos:
                Intent intRetos = new Intent(MainActivity.this, MainActivity.class);
                startActivity(intRetos);
                break;
            // cambiar a la activity del usuario
            case R.id.btnCard:
                Intent intUser = new Intent(MainActivity.this, Usuario.class);
                startActivity(intUser);
            break;
            // cambiar a la activity del usuario
            case R.id.btnLeaderBoard:
                Intent intLeader = new Intent(MainActivity.this, LeaderboardActivity.class);
           ...
           case R.id.button1:
                ...
                Reto1.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //Intent intQr = new Intent(thisd, MainActivity.class);
                        //startActivity(intQr);
                    }
                });
                Reto1.show();
...
// muestra el reto
            ...
            case R.id.button4:
                ...
                Reto4.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                       // Intent intQr = new Intent(getActivity(), MainActivity.class);
                        //startActivity(intQr);
                    }
                });
                Reto4.show();
            ...
            case R.id.button5:
                ...
                Reto5.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                       // Intent intQr = new Intent(MainActivity.this, MainActivity.class);
                        //startActivity(intQr);
                    }
                });
                Reto5.show();
